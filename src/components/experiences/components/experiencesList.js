...
export const experiencesList = [
    {
        ...
        content: (
            <Container>
                <Typography>
                    Kurs trenera personalnego zrobiłem w Polskim Związku
                    Kulturystyki i Fitness. To miejsce wydaje najbardziej
                    prestiżowe uprawnienia trenera personalnego. Podczas kursu
                    nauczyłem się prawidłowego podejścia i pracy z zawodnikiem
                    czyli z Tobą. Wieloletnie doświadczenie szkoleniowców
                    pozwoliło edukować mnie na najwyższych standardach
                    światowych. Dzięki temu i innym kursom moge pracować z Toba
                    na ciężarach, maszynach, TRX, Bosu, treningu funkcjonalnym,
                    treningu z ciężarem własnego ciała, ketlach, workach
                    bułgarskich. Zapraszam do współpracy i poprawiania swojego
                    wyglądu, sprawności.
                </Typography>
            </Container>
        ),
    },
    {
        ...
        content: (
            <Container>
                <Typography>
                    Nurek cmass - to jedna z moich pasji czyli nurkowanie.
                    Podczas nurkowania zauważyłem jak ważna jest aktywność
                    fizyczna. Czesto sobie wyobrażamy nurkowanie jako rozrywkę,
                    ktora możemy porobić na wakacjach czy w wolnym czasie.
                    Pamiętajmy, aby nurkować i czuć się bezpiecznie pod wodą
                    musimy mieć dobra wydolność i być sprawni. I to tylko
                    pokazuje nam to, ze sprawność i dobra wydolność jest nam
                    potrzebna przez całe życie i w każdym miejscu.
                </Typography>
                <Typography variant="h5" color="initial">
                    A czy ty jesteś sprawny? I twoj poziom pozwoli Ci na
                    korzystanie z życia w pełni?
                </Typography>
            </Container>
        ),
    },
    ...
    { id: 20, name: 'Kończyna dolna', area: 'Movement strategy' },
    {
        ...
        content: (
            <React.Fragment>
                <Typography>
                    {' '}
                    Taśmy podwieszane TRX - jak ich używać i czym są?{' '}
                </Typography>
                <Typography>
                    Taśmy TRX to pasy, które umożliwiają nam na trening,
                    aktywność z obciążeniem własnego ciała. Między innymi temu,
                    że możemy je regulować, jest możliwe wykonanie różne
                    ćwiczenia z różnym obciążeniem. Zarówno osoby sprawne jak i
                    mniej sprawne będą mogły ćwiczyć i rozwijać swoją sprawność.
                    To idealna aktywność dla osób, które nie chcą obciążać
                    kręgosłupa oraz stawów zbyt mocno. Trenujące osoba ćwiczą
                    stabilizację, siłę i wydolność podczas treningu z użyciem
                    TRX.
                </Typography>
                <Typography>
                    Taśmy TRX wykonane są z bardzo trwałego polimeru, dlatego
                    warto na początek zainwestować w polecane modele, ponieważ
                    posłużą nam przez długi okres czasu i treningi będą
                    bezpieczne.'
                </Typography>
            </React.Fragment>
        ),
        ...
        content: (
            <Container>
                <Typography variant="body1" color="initial">
                    Jako licencjonowany master trener worka bułgarskiego
                    chciałem polecić tą metodę treningu. Zawsze szukasz
                    kompleksowego programu, który będzie w stanie wzmocnić i
                    rozwinąć holistycznie ciało. A co, jeśli w tym celu możesz
                    wykorzystać zaledwie jedego przyrząd. Bułgarski worek to
                    naprawdę niesamowite urządzenie treningiwe. Przeznaczony
                    jest dla każdego, kto chce zadbać o swoje ciało ( poprawa
                    sprawności, kondycji czy wzmocnienie mięśni). Opinie
                    sportowców przemawiają za jego skutecznością, gdyż staje się
                    coraz bardziej popularnym elementem treningu w różnych
                    dyscyplinach. Poznałem wszystkie zalety treningu z workiem i
                    śmiało mogę go polecić w treningach. Również moja wiedza
                    zdobyta na kursach czy treningach z nim pozwoli efektywnie
                    ćwiczyć z użyciem worka.
                </Typography>
